...
function LeagueTablePreview({ leagueTable, focusedSites, currentMonth, isLoading, user, config }) {
    ...
    const columns = config.columns.leagueTables[user.company].home;
            ...
            <CardHeader className="flex justify-between items-start">
                <div>
                    <span className="text-black text-sm font-medium block">
                        {user.company === "Demo" ? "Site League Table" : "Centre League Table"}
                    </span>
                    <span className="uppercase text-[10px] tracking-wider">Group</span>
                </div>
                    ...
                    <>
                        ...
                        >
                            <Table aria-label="Group league table" removeWrapper>
                                ...
                                <TableBody
                                    items={leagueTable.length > 0 ? leagueTable : []}
